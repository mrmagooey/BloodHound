        ...
        queries: [
            {
                ...
                description: '',
                query: `MATCH p = (:AZBase)-[:AZGlobalAdmin*1..10]->(:AZTenant)\nRETURN p\nLIMIT 1000`,
            },
            {
